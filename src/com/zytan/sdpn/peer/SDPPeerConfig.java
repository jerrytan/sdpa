 ...
 *
 */
public class SDPPeerConfig extends Configure {
	...
	/*
	 * API List for this peer ,for ex: api_list=lightOn,lightOff
	 */
	public String api_list = null;
	...
	public SDPPeerConfig(String file){
	...
	{  
		...
		if (attribute.equals("api_list")) { this.api_list= par.getString();return; }
